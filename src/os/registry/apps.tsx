...
export const APPS: AppMeta[] = [
  {
    ...
    icon: "✎",
    accent: "green",
    description: "Escrever, revisar e traduzir com IA.",
    component: TextAI,
  ...
  },
  {
    ...
    icon: "</>",
    accent: "blue",
    description: "Gerar, explicar e refatorar código.",
    component: CodeAI,
  ...
  },
  {
    ...
    icon: "◉",
    accent: "yellow",
    description: "Conceitos e prompts visuais.",
    component: VisionAI,
  ...
  },
  {
    ...
    icon: "≡",
    accent: "green",
    description: "Insights sobre dados tabulares.",
    component: DataAI,
  ...
  },
  {
    ...
    icon: "◆",
    accent: "blue",
    description: "Crie e converse com agentes de IA.",
    component: AgentOS,
  ...
  },
  {
    ...
    icon: "▸_",
    accent: "neutral",
    description: "Terminal explicativo por IA.",
