      ...
      messages: [
        {
          role: "system",
          content:
            "Você é um analista de dados. Responda em português, com bullets, insights numéricos e sugestões.",
        },
      ...
      <div className="grid h-full grid-cols-1 gap-3 p-3 lg:grid-cols-2">
        <div className="flex min-h-0 flex-col gap-2">
          <textarea
            ...
            className="h-32 resize-none rounded-md bg-secondary p-2 font-mono text-xs outline-none"
